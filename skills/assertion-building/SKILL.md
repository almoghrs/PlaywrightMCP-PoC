...
description: How to write reliable, non-flaky assertions in Playwright tests. Covers web-first assertions, soft assertions, custom timeouts, and common anti-patterns that lead to intermittent failures. Use when adding expect() calls to tests.
---
